...
Copy and paste the [code block](/combobox/Sheet1.bas) below to populate the combo box data list with com port names from the host PC when the combo drop button is clicked.
