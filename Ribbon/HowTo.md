...
4. Selecting the Com port shown updates cell with formula `=Read_Ribbon_Combo()` result
...
4. Selecting a Com port updates cell with formula `=Read_Ribbon_Combo()` result
