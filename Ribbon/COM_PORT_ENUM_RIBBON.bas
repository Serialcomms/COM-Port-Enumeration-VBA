...
Sub GetPortSelection(control As IRibbonControl, PortText As String)                 ' Ribbon Callback for CP_Selector onChange

Com_Port_Selected = IIf(Com_Port_Count = LONG_0, vbNullString, PortText)
