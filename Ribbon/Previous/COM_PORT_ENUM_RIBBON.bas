...
If Query_Com_Ports < LONG_1 Then

    ComboText = TEXT_NO_COM_PORTS

Else

    ComboText = Com_Port_Names(LONG_1)
...
Sub GetEditLabel(control As IRibbonControl, ByRef LabelText)                    'Callback for CP_Editbox onChange
